    ...
    <ServicePageV2 {...service}>
      <div className="my-8">
        <p className="text-gray-700 leading-relaxed">
          ...
          we provide fast and secure digital fingerprinting for background checks. We also offer <InternalLink variant="geo" to="/notary">notary services</InternalLink> for your important documents.
        </p>
      </div>
    </ServicePageV2>
  );
