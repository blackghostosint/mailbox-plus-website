      ...
      <div className="space-y-8">
            ...
            <div>
              ...
              <div className="bg-green-50 border border-green-200 p-4 rounded-lg">
                <p className="font-medium text-green-800">
                  We CAN accept Amazon returns when Amazon provides a printable shipping label (UPS,
                  USPS, or FedEx).
                </p>
                <p className="text-sm text-green-700 mt-1">
                  If you do not have a printer, we can print the label for you for a small $2.00
                  fee.
                </p>
              </div>
            </div>
        ...
        <div className="space-y-6 text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg text-[var(--color-text-secondary)] leading-relaxed">
            ...
            for pre-labeled packages. While you&apos;re here, we can also help with{' '}
            <InternalLink variant="geo" to="/pack-ship">
              packing other shipments
            </InternalLink>{' '}
            or{' '}
