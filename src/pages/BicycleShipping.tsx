    ...
    <ServicePage {...service}>
      <div className="my-8">
        <p className="text-gray-700 leading-relaxed">
          ...
          We can ship your bike via <InternalLink variant="geo" to="/pack-ship/fedex-shipping">FedEx</InternalLink> or <InternalLink variant="geo" to="/pack-ship/ups-authorized-shipper-outlet">UPS</InternalLink>.
        </p>
      </div>
    </ServicePage>
  );
