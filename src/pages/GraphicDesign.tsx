    ...
    <ServicePageV2 {...service}>
      <div className="my-8">
        <p className="text-gray-700 leading-relaxed">
          ...
          . Whether you need{' '}
          <InternalLink variant="geo" to="/copy-print/business-cards">
            business cards
          </InternalLink>
          ,{' '}
          <InternalLink variant="geo" to="/copy-print/flyers-brochures">
            flyers
          </InternalLink>
          , or large format{' '}
          <InternalLink variant="geo" to="/copy-print/posters-printing">
            posters
          </InternalLink>
