    ...
    <ServicePage {...service}>
      <div className="my-8">
        <p className="text-gray-700 leading-relaxed">
          ...
          While you're here, check out our <InternalLink variant="geo" to="/mailbox-rental">private mailbox rentals</InternalLink> or ask about <InternalLink variant="geo" to="/pack-ship/usps-services">certified mail services</InternalLink>.
        </p>
      </div>
    </ServicePage>
  );
