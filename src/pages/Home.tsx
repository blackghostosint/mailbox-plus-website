    ...
    <div className="bg-[var(--color-bg-primary)] min-h-screen">
      ...
      <section className="relative bg-center py-20 md:py-32 lg:py-48 overflow-hidden min-h-[70vh] md:min-h-[80vh]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-white/90 mb-10 leading-relaxed max-w-3xl mx-auto animate-fade-in-up [animation-delay:300ms] opacity-0 [animation-fill-mode:forwards]">
