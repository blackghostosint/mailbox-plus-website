...
export const PlusPointsAdmin: React.FC = () => {
  ...
  return (
    <>
      <Meta
        title="Plus Points Counter Console | Mailbox Plus"
        description="The store register counter tool for managing customer loyalty profiles, logging shipping points, and processing reward redemptions."
