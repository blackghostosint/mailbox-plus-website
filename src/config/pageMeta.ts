...
export const pageMeta: Record<string, { title: string; description: string; schema?: (WithContext<LocalBusiness> | WithContext<WebPage> | WithContext<Service>)[] }> = {
  ...
  '/': {
    title: 'Mailbox Plus Bolt - Your Shipping and Business Services Partner',
    description: 'Mailbox Plus Bolt offers reliable shipping, mailbox rentals, printing, and notary services. Your one-stop shop for personal and business needs.',
    schema: [localBusinessSchema],
  },
  // Services page
  '/services': {
    title: 'Our Services | Mailbox Plus Bolt',
  ...
  '/about-us': {
    title: 'About Us | Mailbox Plus Bolt',
    description: 'Learn about Mailbox Plus Bolt — your trusted local pack-and-ship store in Concord Township, Lake County, Ohio. Family-owned, faith-guided, serving neighbors with care.',
