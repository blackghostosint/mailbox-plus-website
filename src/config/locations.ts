...
export const primaryLocations: LocationData[] = [
  ...
  },
  {
    ...
    population: 47000,
    uniqueContent: {
      directions: "From Mentor, take Route 44 south about 3 miles. We're in Capital Plaza on the left, past Johnnycake Ridge.",
      landmarks: ['Mentor Headlands Beach', 'Great Lakes Mall', 'Mentor Civic Center', 'Steele Mansion'],
  ...
  },
  {
    ...
    population: 24000,
    uniqueContent: {
      directions: "From downtown Willoughby, take Route 306 north to Route 6, then east to Route 44 south. We're about 8 minutes from there.",
      landmarks: ['Downtown Willoughby', 'Lost Nation Airport', 'Willoughby Town Center', 'Lakeland Community College'],
...
export const secondaryLocations: LocationData[] = [
  {
    ...
    population: 7000,
    uniqueContent: {
      directions: "From Kirtland, take Route 306 to Route 6 east, then Route 44 south. About 10 minutes total.",
  ...
  },
  {
    ...
    population: 3200,
    uniqueContent: {
      directions: "From Madison, take Route 528 to Route 6 west, then Route 44 south. About 20 minutes.",
  ...
  },
  {
    ...
    population: 18000,
    uniqueContent: {
      directions: "From Eastlake, take Vine Street to Route 306 north, then Route 6 east to Route 44 south.",
  ...
  },
  {
    ...
    population: 12500,
    uniqueContent: {
      directions: "From Wickliffe, take Route 306 north to Route 6 east, then Route 44 south. About 10 minutes.",
...
export const locationEligibleServices = [
  {
    ...
    metaTemplate: 'Drop off your UPS packages at Mailbox Plus in {city}. No lines, expert packing help, same-day pickup. Open 6 days a week.',
  },
  {
    serviceName: 'FedEx Shipping',
    slug: 'fedex-shipping',
    searchPattern: 'FedEx shipping near me',
    metaTemplate: 'Ship FedEx from Mailbox Plus near {city}. Ground, Express, International. We pack it right and get it out same-day.',
  },
  {
    serviceName: 'Package Shipping',
    slug: 'package-shipping',
    searchPattern: 'package shipping near me',
    metaTemplate: 'Need to ship a package from {city}? Mailbox Plus compares UPS, FedEx, and USPS to find you the best rate.',
  },
  {
    serviceName: 'Notary Services',
    slug: 'notary',
    searchPattern: 'notary near me',
    metaTemplate: 'Walk-in notary near {city}. No appointment needed. $5 per signature. Open 6 days a week.',
  },
  {
  ...
  },
  {
    ...
    metaTemplate: 'Print documents near {city}. Color copies, business cards, flyers, banners. Same-day service available.',
  },
  {
    serviceName: 'Fax Services',
    slug: 'fax',
    searchPattern: 'fax near me',
    metaTemplate: 'Send or receive faxes near {city}. Walk in, no appointment. $1 per page to send, $0.50 to receive.',
  },
  {
    serviceName: 'Shredding Services',
    slug: 'shredding',
    searchPattern: 'shredding near me',
    metaTemplate: 'Secure document shredding near {city}. Micro-cut technology, watch-while-we-shred, HIPAA compliant.',
  },
];
