    ...
    <ServicePageV2 {...service}>
      <div className="my-8">
        <p className="text-gray-700 leading-relaxed">
          ...
          No appointment needed for most documents. We can also help you <InternalLink variant="geo" to="/shipping">ship</InternalLink> your notarized documents or provide <InternalLink variant="geo" to="/copy-print/copies">copies</InternalLink> for your records.
        </p>
      </div>
    </ServicePageV2>
  );
