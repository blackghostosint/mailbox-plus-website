    ...
    <ServicePageV2 {...service}>
      <div className="my-8">
        <p className="text-gray-700 leading-relaxed">
          ...
          Our posters and banners are printed with precision and care. We also offer <InternalLink variant="geo" to="/copy-print/graphic-design">professional graphic design</InternalLink> to help you create stunning visuals.
        </p>
      </div>
    </ServicePageV2>
  );
