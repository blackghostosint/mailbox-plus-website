    ...
    <ServicePageV2 {...service}>
      <div className="my-8">
        <p className="text-gray-700 leading-relaxed">
          ...
          We offer high-resolution scanning to email or USB drive. Once digitized, we can help you with <InternalLink variant="geo" to="/home-business/document-shredding">secure shredding</InternalLink> of the originals.
        </p>
      </div>
    </ServicePageV2>
  );
