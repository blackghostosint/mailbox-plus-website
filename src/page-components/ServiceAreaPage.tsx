...
export const ServiceAreaContent: React.FC<{ slug: string }> = ({ slug }) => {
  ...
  if (!area) {
    return (
      <div className="max-w-4xl mx-auto py-20 text-center">
        ...
        <p className="text-gray-600 mt-4">Sorry, we don&apos;t have a service area page for this location yet.</p>
      </div>
    );
  }
  ...
  return <ServicePageV2 {...areaWithContent} breadcrumbsBaseUrl="/service-area" breadcrumbsLabel="Service Areas" />;
};
