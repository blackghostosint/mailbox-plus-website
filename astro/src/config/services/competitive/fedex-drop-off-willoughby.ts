...
export const competePages: Service[] = [
  {
    id: 'fedex-drop-off-willoughby',
    category: 'pack-ship',
    city: 'Willoughby',
    serviceName: 'FedEx Drop-Off in Willoughby — Authorized Location Near You | Mailbox Plus',
    slug: '/fedex-drop-off-willoughby',
    canonicalUrl: 'https://mailboxplusohio.com/fedex-drop-off-willoughby',
    pageTitle: 'FedEx Drop-Off in Willoughby — Authorized Location Near You | Mailbox Plus',
    metaDescription: "Looking for a FedEx drop-off location near Willoughby, OH? Mailbox Plus is an authorized FedEx ShipCenter on Fredle Drive — in and out fast.",
    keywords: 'FedEx drop-off Willoughby, Willoughby FedEx shipping, Mailbox Plus Concord',
    heroTitle: 'FedEx Drop-Off in Willoughby — Authorized Location Near You',
    heroSubtitle: "Authorized FedEx, UPS, USPS, and DHL drop-off and shipping near Willoughby. In and out fast.",
    features: [
      {
        title: 'In & Out Fast',
