...
export const competePages: Service[] = [
  {
    id: 'ups-drop-off-fairport-harbor',
    headJsonLd: getImageObjectSchema({
      contentUrl:
        'https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/articles/pack-ship/ups-drop-off-fairport-harbor-featured.webp',
      name: 'UPS Drop-Off Near Fairport Harbor — Easy & Fast | Mailbox Plus',
      description: 'Mailbox Plus shipping service for Fairport Harbor customers',
    }),
    category: 'pack-ship',
    city: 'Fairport Harbor',
    serviceName: 'UPS Drop-Off Near Fairport Harbor — Easy & Fast | Mailbox Plus',
    slug: '/ups-drop-off-fairport-harbor',
    canonicalUrl: 'https://mailboxplusohio.com/ups-drop-off-fairport-harbor',
    pageTitle: 'UPS Drop-Off Near Fairport Harbor — Easy & Fast | Mailbox Plus',
    metaDescription:
      'UPS drop-off near Fairport Harbor, OH. Drop your pre-labeled UPS package at Mailbox Plus — also handles FedEx, USPS, and DHL returns.',
    keywords: 'UPS drop-off Fairport Harbor, Fairport Harbor UPS shipping, Mailbox Plus Concord',
    heroTitle: 'UPS Drop-Off Near Fairport Harbor — Easy & Fast',
    heroSubtitle:
