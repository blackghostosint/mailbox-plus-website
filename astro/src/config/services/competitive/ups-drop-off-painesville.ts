...
export const competePages: Service[] = [
  {
    id: 'ups-drop-off-painesville',
    headJsonLd: {
      '@context': 'https://schema.org',
      '@type': 'ImageObject',
      contentUrl:
        'https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/articles/pack-ship/ups-drop-off-painesville-featured.webp',
      description: 'Mailbox Plus shipping service for Painesville customers',
      name: 'UPS Drop-Off in Painesville — Skip the Lines | Mailbox Plus',
      author: {
        '@type': 'Organization',
        name: 'Mailbox Plus',
      },
    ...
    canonicalUrl: 'https://mailboxplusohio.com/ups-drop-off-painesville',
    ...
    keywords: 'UPS drop-off Painesville, Painesville UPS shipping, Mailbox Plus Concord',
    heroTitle: 'UPS Drop-Off in Painesville — Skip the Lines',
    heroSubtitle:
