...
export const competePages: Service[] = [
  {
    ...
    canonicalUrl: '/fedex-office-alternative-mentor/',
    ...
    heroTitle: 'FedEx Office Alternative in Mentor — Compare All 4 Carriers',
    heroSubtitle:
