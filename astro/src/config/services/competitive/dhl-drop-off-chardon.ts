...
export const competePages: Service[] = [
  {
    ...
    keywords: 'DHL drop-off Chardon, Chardon DHL shipping, Mailbox Plus Concord',
    heroTitle: 'DHL Drop-Off Near Chardon — Easy Drop',
    heroSubtitle:
