...
export const competePages: Service[] = [
  {
    id: 'happy-returns-fairport-harbor',
    ogImage:
      'https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/articles/pack-ship/happy-returns-fairport-harbor-featured.webp',
    headJsonLd: getImageObjectSchema({
      contentUrl:
        'https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/articles/pack-ship/happy-returns-fairport-harbor-featured.webp',
      name: 'Happy Returns Drop-Off Near Fairport Harbor — Easy Returns | Mailbox Plus',
    ...
    canonicalUrl: '/happy-returns-fairport-harbor',
    ...
    keywords:
      'Happy Returns Fairport Harbor, return drop-off Fairport Harbor, Mailbox Plus Concord',
    heroTitle: 'Happy Returns Drop-Off Near Fairport Harbor — Easy Returns',
    heroSubtitle:
