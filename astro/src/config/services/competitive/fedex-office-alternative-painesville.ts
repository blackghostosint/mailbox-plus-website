...
export const competePages: Service[] = [
  {
    ...
    headJsonLd: getImageObjectSchema({
      contentUrl:
        'https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/articles/pack-ship/fedex-office-alternative-painesville-featured.webp',
      name: 'FedEx Office Alternative in Painesville — More Options, Less Wait | Mailbox Plus',
    ...
    keywords:
      'FedEx Office alternative Painesville, Painesville shipping services, Mailbox Plus Concord',
    heroTitle: 'FedEx Office Alternative in Painesville — More Options, Less Wait',
    heroSubtitle:
