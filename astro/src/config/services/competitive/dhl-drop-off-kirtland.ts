...
export const competePages: Service[] = [
  {
    ...
    ogImage:
      'https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/articles/pack-ship/dhl-drop-off-kirtland-featured.webp',
    headJsonLd: getImageObjectSchema({
      contentUrl:
        'https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/articles/pack-ship/dhl-drop-off-kirtland-featured.webp',
      name: 'DHL Drop-Off Near Kirtland — Minutes Away | Mailbox Plus',
    ...
    canonicalUrl: '/dhl-drop-off-kirtland/',
