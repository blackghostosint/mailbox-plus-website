...
export const competePages: Service[] = [
  {
    ...
    metaDescription: "Looking for a FedEx drop-off near Kirtland, OH? Mailbox Plus is just 4 miles away on Fredle Drive in Concord Township.",
    ...
    heroSubtitle: "Authorized FedEx, UPS, USPS, and DHL drop-off and shipping near Kirtland. In and out fast.",
    features: [
      {
        title: 'In & Out Fast',
    ...
    faqs: [
      {
        ...
        answer: 'Mailbox Plus is located at 7554 Fredle Drive in Concord Township, just 4 miles from Kirtland. The drive is quick and easy.',
      },
      {
