...
export const competePages: Service[] = [
  {
    ...
    keywords:
      'UPS Store alternative, Chardon, Mailbox Plus, shipping, Chardon ups store, Chardon shipping, Chardon printing',
    heroTitle: 'The UPS Store Alternative Chardon Needs — All 4 Carriers at One Counter',
    heroSubtitle:
      ...
      },
      {
        ...
        body: `<div class="grid md:grid-cols-2 gap-6 mb-8">
              ...
              <div class="p-6 bg-[var(--color-bg-secondary)] rounded-2xl border border-[var(--color-border)]">
                ...
                <p class="text-sm text-[var(--color-text-secondary)]">Part of the Chardon community. Friendly faces, no corporate bureaucracy.</p>
              </div>
              <div class="p-6 bg-[var(--color-bg-secondary)] rounded-2xl border border-[var(--color-border)]">
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes, we are a locally owned and operated independent business serving Chardon and all of Lake County, committed to excellent customer service.',
      },
      {
        question: 'How far is Mailbox Plus from Chardon?',
        answer:
          "We're located at 7554 Fredle Drive in Concord Township, about 20 minutes from Chardon. It's an easy drive — and worth it for access to all 4 carriers.",
      },
      {
        question: 'Do you offer mailbox rentals for Chardon residents?',
        answer:
          'Absolutely! Our private mailboxes with real street addresses serve customers from Chardon and all across Lake County. From $35/month with 4-hour email notification.',
      },
      {
