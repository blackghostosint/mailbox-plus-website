...
export const competePages: Service[] = [
  {
    ...
    ogImage:
      'https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/articles/pack-ship/ups-drop-off-madison-featured.webp',
    headJsonLd: getImageObjectSchema({
      contentUrl:
        'https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/articles/pack-ship/ups-drop-off-madison-featured.webp',
      name: 'UPS Drop-Off Near Madison — Worth the Drive | Mailbox Plus',
