...
export const competePages: Service[] = [
  {
    ...
    keywords: 'DHL drop-off Mentor, Mentor DHL shipping, Mailbox Plus Concord',
    heroTitle: 'DHL Drop-Off in Mentor — In & Out Fast',
    heroSubtitle:
