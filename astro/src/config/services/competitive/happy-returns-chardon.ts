...
export const competePages: Service[] = [
  {
    id: 'happy-returns-chardon',
    ogImage:
      'https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/articles/pack-ship/happy-returns-chardon-featured.webp',
    headJsonLd: getImageObjectSchema({
      contentUrl:
        'https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/articles/pack-ship/happy-returns-chardon-featured.webp',
      name: 'Happy Returns Drop-Off Near Chardon — Local Service | Mailbox Plus',
    ...
    canonicalUrl: '/happy-returns-chardon/',
    ...
    heroTitle: 'Happy Returns Drop-Off Near Chardon — Local Service',
    heroSubtitle:
