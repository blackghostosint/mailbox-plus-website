...
export const competePages: Service[] = [
  {
    ...
    headJsonLd: getImageObjectSchema({
      contentUrl:
        'https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/articles/pack-ship/fedex-office-alternative-willoughby-featured.webp',
      name: 'FedEx Office Alternative in Willoughby — 4 Carriers, 1 Counter | Mailbox Plus',
    ...
    canonicalUrl: '/fedex-office-alternative-willoughby',
    ...
    keywords:
      'FedEx Office alternative Willoughby, Willoughby shipping services, Mailbox Plus Concord',
    heroTitle: 'FedEx Office Alternative in Willoughby — 4 Carriers, 1 Counter',
    heroSubtitle:
