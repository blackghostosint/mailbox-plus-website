...
export const competePages: Service[] = [
  {
    ...
    headJsonLd: getImageObjectSchema({
      contentUrl:
        'https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/articles/pack-ship/ups-store-alternative-painesville-featured.webp',
    ...
    keywords:
      'UPS Store alternative, Painesville, Mailbox Plus, shipping, Painesville ups store, Painesville shipping, Painesville printing',
    heroTitle: 'The UPS Store Alternative Painesville Needs — All 4 Carriers at One Counter',
    heroSubtitle:
    ...
    features: [
      ...
      {
        title: 'Locally Owned',
        description: 'We are proud to serve the Painesville community.',
        icon: MapPin,
      },
    ],
    content: [
      ...
      },
      {
        ...
        body: `<div class="grid md:grid-cols-2 gap-6 mb-8">
              ...
              <div class="p-6 bg-[var(--color-bg-secondary)] rounded-2xl border border-[var(--color-border)]">
                ...
                <p class="text-sm text-[var(--color-text-secondary)]">Part of the Painesville community. Friendly faces, no corporate bureaucracy.</p>
              </div>
              <div class="p-6 bg-[var(--color-bg-secondary)] rounded-2xl border border-[var(--color-border)]">
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes, we are a locally owned and operated independent business serving Painesville and all of Lake County, committed to excellent customer service.',
      },
      {
        question: 'How far is Mailbox Plus from Painesville?',
        answer:
          "We're located at 7554 Fredle Drive in Concord Township, about 8 minutes from Painesville. It's an easy drive — and worth it for access to all 4 carriers.",
      },
      {
        question: 'Do you offer mailbox rentals for Painesville residents?',
        answer:
          'Absolutely! Our private mailboxes with real street addresses serve customers from Painesville and all across Lake County. From $35/month with 4-hour email notification.',
      },
      {
