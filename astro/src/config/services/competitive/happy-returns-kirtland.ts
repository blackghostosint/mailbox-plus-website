...
export const competePages: Service[] = [
  {
    id: 'happy-returns-kirtland',
    ogImage:
      'https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/articles/pack-ship/happy-returns-kirtland-featured.webp',
    headJsonLd: getImageObjectSchema({
      contentUrl:
        'https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/articles/pack-ship/happy-returns-kirtland-featured.webp',
      name: 'Happy Returns Drop-Off Near Kirtland — Minutes Away | Mailbox Plus',
    ...
    keywords: 'Happy Returns Kirtland, return drop-off Kirtland, Mailbox Plus Concord',
    heroTitle: 'Happy Returns Drop-Off Near Kirtland — Minutes Away',
    heroSubtitle:
