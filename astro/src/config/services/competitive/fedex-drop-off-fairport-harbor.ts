...
export const competePages: Service[] = [
  {
    id: 'fedex-drop-off-fairport-harbor',
    category: 'pack-ship',
    city: 'Fairport Harbor',
    serviceName: 'FedEx Drop-Off Near Fairport Harbor — Local Service | Mailbox Plus',
    slug: '/fedex-drop-off-fairport-harbor',
    canonicalUrl: 'https://mailboxplusohio.com/fedex-drop-off-fairport-harbor',
    pageTitle: 'FedEx Drop-Off Near Fairport Harbor — Local Service | Mailbox Plus',
    metaDescription: "Looking for a FedEx drop-off near Fairport Harbor, OH? Mailbox Plus handles FedEx, UPS, USPS, and DHL — all at one counter.",
    keywords: 'FedEx drop-off Fairport Harbor, Fairport Harbor FedEx shipping, Mailbox Plus Concord',
    heroTitle: 'FedEx Drop-Off Near Fairport Harbor — Local Service',
    heroSubtitle: "Authorized FedEx, UPS, USPS, and DHL drop-off and shipping near Fairport Harbor. In and out fast.",
    features: [
      {
        title: 'In & Out Fast',
    ...
    faqs: [
      {
        ...
        answer: 'Mailbox Plus is located at 7554 Fredle Drive in Concord Township, just 11 miles from Fairport Harbor. The drive is quick and easy.',
      },
      {
