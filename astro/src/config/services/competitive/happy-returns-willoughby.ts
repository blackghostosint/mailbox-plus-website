...
export const competePages: Service[] = [
  {
    ...
    ogImage:
      'https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/articles/pack-ship/happy-returns-willoughby-featured.webp',
    headJsonLd: getImageObjectSchema({
      contentUrl:
        'https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/articles/pack-ship/happy-returns-willoughby-featured.webp',
      name: 'Happy Returns Drop-Off in Willoughby — Fast & Easy | Mailbox Plus',
    ...
    canonicalUrl: '/happy-returns-willoughby/',
