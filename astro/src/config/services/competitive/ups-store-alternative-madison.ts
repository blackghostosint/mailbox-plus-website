...
export const competePages: Service[] = [
  {
    id: 'ups-store-alternative-madison',
    headJsonLd: {
      '@context': 'https://schema.org',
      '@type': 'ImageObject',
      contentUrl:
        'https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/articles/pack-ship/ups-store-alternative-madison-featured.webp',
      description: 'Mailbox Plus UPS Store Alternative serving Madison customers',
      name: 'UPS Store Alternative in Madison, Ohio | Mailbox Plus',
      author: {
        '@type': 'Organization',
        name: 'Mailbox Plus',
      },
    ...
    canonicalUrl: 'https://mailboxplusohio.com/ups-store-alternative-madison',
    ...
    keywords:
      'UPS Store alternative, Madison, Mailbox Plus, shipping, Madison ups store, Madison shipping, Madison printing',
    heroTitle: 'The UPS Store Alternative Madison Needs — All 4 Carriers at One Counter',
    heroSubtitle:
      ...
      },
      {
        ...
        body: `<div class="grid md:grid-cols-2 gap-6 mb-8">
              ...
              <div class="p-6 bg-[var(--color-bg-secondary)] rounded-2xl border border-[var(--color-border)]">
                ...
                <p class="text-sm text-[var(--color-text-secondary)]">Part of the Madison community. Friendly faces, no corporate bureaucracy.</p>
              </div>
              <div class="p-6 bg-[var(--color-bg-secondary)] rounded-2xl border border-[var(--color-border)]">
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes, we are a locally owned and operated independent business serving Madison and all of Lake County, committed to excellent customer service.',
      },
      {
        question: 'How far is Mailbox Plus from Madison?',
        answer:
          "We're located at 7554 Fredle Drive in Concord Township, about 15 minutes from Madison. It's an easy drive — and worth it for access to all 4 carriers.",
      },
      {
        question: 'Do you offer mailbox rentals for Madison residents?',
        answer:
          'Absolutely! Our private mailboxes with real street addresses serve customers from Madison and all across Lake County. From $35/month with 4-hour email notification.',
      },
      {
