...
export const competePages: Service[] = [
  {
    ...
    category: 'pack-ship',
    city: 'Mentor',
    serviceName: 'Happy Returns Drop-Off in Mentor — One Stop | Mailbox Plus',
    ...
    keywords: 'Happy Returns Mentor, return drop-off Mentor, Mailbox Plus Concord',
    heroTitle: 'Happy Returns Drop-Off in Mentor — One Stop',
    heroSubtitle:
