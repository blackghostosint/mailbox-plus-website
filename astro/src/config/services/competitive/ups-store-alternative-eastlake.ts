...
export const competePages: Service[] = [
  {
    ...
    keywords:
      'UPS Store alternative, Eastlake, Mailbox Plus, shipping, Eastlake ups store, Eastlake shipping, Eastlake printing',
    heroTitle: 'Similar to the UPS Store in Eastlake, But With All 4 Carriers — and Shorter Lines',
    heroSubtitle:
    ...
    features: [
      {
        ...
        description: 'No waiting in Vine Street TUPS lines.',
        icon: Clock,
      },
      {
      ...
      {
        title: 'Locally Owned',
        description: 'We are proud to serve the Eastlake community.',
        icon: MapPin,
      },
    ],
    content: [
      {
        heading: 'Looking for a UPS Store in Eastlake? We Do Everything They Do — Plus More',
        body: `<p class="text-lg text-[var(--color-text-primary)] leading-relaxed mb-6">
              If you're searching for a <strong>UPS Store in Eastlake</strong>, you've probably been to The UPS Store on Vine Street before — the line, the franchise pricing, and the fact that they can only ship UPS. What if you could walk into a place that offers everything The UPS Store does, but also gives you access to FedEx, USPS, and DHL?
            </p>
            <p class="text-lg text-[var(--color-text-primary)] leading-relaxed mb-6">
              That's Mailbox Plus. We are your locally owned <strong>UPS Store alternative in Eastlake, Ohio</strong>. We offer the same UPS authorized shipping, <a href="/home-business/mailbox-rental" class="text-[var(--color-primary)] hover:underline">mailbox rentals</a>, <a href="/copy-print" class="text-[var(--color-primary)] hover:underline">printing</a>, and <a href="/home-business/notary-services" class="text-[var(--color-primary)] hover:underline">notary services</a> — plus we can ship FedEx, USPS, and DHL too. One counter, four carriers, faster service.
            </p>
            <p class="text-lg text-[var(--color-text-primary)] leading-relaxed">
              And since we're locally owned and operated in Concord Township — just 7 miles from Vine Street TUPS — you get personalized service with shorter wait times. No franchise overhead, no pressure to use one carrier.
            </p>`,
      },
      {
      ...
      },
      {
        ...
        body: `<div class="grid md:grid-cols-2 gap-6 mb-8">
              <div class="p-6 bg-[var(--color-bg-secondary)] rounded-2xl border border-[var(--color-border)]">
                ...
                <p class="text-sm text-[var(--color-text-secondary)]">No waiting in Vine Street TUPS lines.</p>
              </div>
              <div class="p-6 bg-[var(--color-bg-secondary)] rounded-2xl border border-[var(--color-border)]">
              ...
              <div class="p-6 bg-[var(--color-bg-secondary)] rounded-2xl border border-[var(--color-border)]">
                ...
                <p class="text-sm text-[var(--color-text-secondary)]">Part of the Eastlake community. Friendly faces, no corporate bureaucracy.</p>
              </div>
              <div class="p-6 bg-[var(--color-bg-secondary)] rounded-2xl border border-[var(--color-border)]">
    ...
    faqs: [
      {
        question: 'Can I ship FedEx or USPS at Mailbox Plus in Eastlake?',
        answer:
          'Yes! Unlike The UPS Store on Vine Street, we are an authorized shipping center for FedEx, USPS, UPS, and DHL — giving you more choices at one counter.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Yes, we are a locally owned and operated independent business serving Eastlake and all of Lake County, committed to excellent customer service.',
      },
      {
        question: 'How far is Mailbox Plus from Eastlake?',
        answer:
          "We're located at 7554 Fredle Drive in Concord Township, about 10 minutes from Eastlake. It's an easy drive — and worth it for access to all 4 carriers.",
      },
      {
        question: 'Do you offer mailbox rentals for Eastlake residents?',
        answer:
          'Absolutely! Our private mailboxes with real street addresses serve customers from Eastlake and all across Lake County. From $35/month with 4-hour email notification.',
      },
      {
