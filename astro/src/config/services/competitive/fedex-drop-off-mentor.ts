...
export const competePages: Service[] = [
  {
    ...
    ogImage:
      'https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/articles/pack-ship/fedex-drop-off-mentor-featured.webp',
    headJsonLd: getImageObjectSchema({
      contentUrl:
        'https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/articles/pack-ship/fedex-drop-off-mentor-featured.webp',
      name: 'Skip the FedEx Office Line — FedEx Drop-Off in Mentor | Mailbox Plus',
