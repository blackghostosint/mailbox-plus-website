...
export const competePages: Service[] = [
  {
    ...
    metaDescription: "FedEx drop-off near Mentor, OH without the corporate lines. Mailbox Plus in Concord Township is your authorized FedEx ShipCenter.",
    ...
    heroSubtitle: "Authorized FedEx, UPS, USPS, and DHL drop-off and shipping near Mentor. In and out fast.",
    features: [
      {
        title: 'In & Out Fast',
    ...
    faqs: [
      {
        ...
        answer: 'Mailbox Plus is located at 7554 Fredle Drive in Concord Township, just 6 miles from Mentor. The drive is quick and easy.',
      },
      {
