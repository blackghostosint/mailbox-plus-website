...
export const competePages: Service[] = [
  {
    id: 'ups-store-alternative-fairport-harbor',
    headJsonLd: {
      '@context': 'https://schema.org',
      '@type': 'ImageObject',
      contentUrl:
        'https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/articles/pack-ship/ups-store-alternative-fairport-harbor-featured.webp',
      description: 'Mailbox Plus UPS Store Alternative serving Fairport Harbor customers',
      name: 'UPS Store Alternative in Fairport Harbor, Ohio | Mailbox Plus',
      author: {
        '@type': 'Organization',
        name: 'Mailbox Plus',
      },
    ...
    keywords:
      'UPS Store alternative, Fairport Harbor, Mailbox Plus, shipping, Fairport Harbor ups store, Fairport Harbor shipping, Fairport Harbor printing',
    heroTitle: 'The UPS Store Alternative Fairport Harbor Needs — All 4 Carriers at One Counter',
    heroSubtitle:
    ...
    features: [
      ...
      {
        title: 'Locally Owned',
        description: 'We are proud to serve the Fairport Harbor community.',
        icon: MapPin,
      },
    ],
    content: [
      ...
      },
      {
        ...
        body: `<div class="grid md:grid-cols-2 gap-6 mb-8">
              ...
              <div class="p-6 bg-[var(--color-bg-secondary)] rounded-2xl border border-[var(--color-border)]">
                ...
                <p class="text-sm text-[var(--color-text-secondary)]">Part of the Fairport Harbor community. Friendly faces, no corporate bureaucracy.</p>
              </div>
              <div class="p-6 bg-[var(--color-bg-secondary)] rounded-2xl border border-[var(--color-border)]">
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes, we are a locally owned and operated independent business serving Fairport Harbor and all of Lake County, committed to excellent customer service.',
      },
      {
        question: 'How far is Mailbox Plus from Fairport Harbor?',
        answer:
          "We're located at 7554 Fredle Drive in Concord Township, about 15 minutes from Fairport Harbor. It's an easy drive — and worth it for access to all 4 carriers.",
      },
      {
        question: 'Do you offer mailbox rentals for Fairport Harbor residents?',
        answer:
          'Absolutely! Our private mailboxes with real street addresses serve customers from Fairport Harbor and all across Lake County. From $35/month with 4-hour email notification.',
      },
      {
