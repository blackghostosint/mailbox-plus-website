...
export const competePages: Service[] = [
  {
    ...
    ogImage:
      'https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/articles/pack-ship/fedex-drop-off-eastlake-featured.webp',
    headJsonLd: getImageObjectSchema({
      contentUrl:
        'https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/articles/pack-ship/fedex-drop-off-eastlake-featured.webp',
      name: 'FedEx Drop-Off Near Eastlake — Quick & Easy | Mailbox Plus',
    ...
    content: [
      {
        ...
        body: `<p class="text-lg text-[var(--color-text-primary)] leading-relaxed mb-6">Need to <a href="/pack-ship/fedex-shipping" class="text-[var(--color-primary)] hover:underline">drop off a FedEx package</a> or ship something from Eastlake? Mailbox Plus on Fredle Drive in Concord Township is your authorized FedEx ShipCenter — just 9 miles from Eastlake near SR 2 and SR 91.</p><p class="text-lg text-[var(--color-text-primary)] leading-relaxed">Skip the corporate FedEx Office lines. Same FedEx service, same tracking, same reliability — with a shorter wait and local service.</p>`,
      },
      {
