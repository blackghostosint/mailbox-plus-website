...
export const competePages: Service[] = [
  {
    id: 'dhl-drop-off-willoughby',
    headJsonLd: getImageObjectSchema({
      contentUrl:
        'https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/articles/pack-ship/dhl-drop-off-willoughby-featured.webp',
      name: 'DHL Drop-Off in Willoughby — Quick & Easy | Mailbox Plus',
    ...
    keywords: 'DHL drop-off Willoughby, Willoughby DHL shipping, Mailbox Plus Concord',
    heroTitle: 'DHL Drop-Off in Willoughby — Quick & Easy',
    heroSubtitle:
