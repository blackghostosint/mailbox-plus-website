...
export const competePages: Service[] = [
  {
    ...
    keywords: 'DHL drop-off Eastlake, Eastlake DHL shipping, Mailbox Plus Concord',
    heroTitle: 'DHL Drop-Off Near Eastlake — No Hassle',
    heroSubtitle:
