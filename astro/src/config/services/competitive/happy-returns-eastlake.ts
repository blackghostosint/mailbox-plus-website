...
export const competePages: Service[] = [
  {
    id: 'happy-returns-eastlake',
    ogImage:
      'https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/articles/pack-ship/happy-returns-eastlake-featured.webp',
    headJsonLd: getImageObjectSchema({
      contentUrl:
        'https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/articles/pack-ship/happy-returns-eastlake-featured.webp',
      name: 'Happy Returns Drop-Off Near Eastlake — No Hassle | Mailbox Plus',
    ...
    canonicalUrl: '/happy-returns-eastlake',
    ...
    heroTitle: 'Happy Returns Drop-Off Near Eastlake — No Hassle',
    heroSubtitle:
