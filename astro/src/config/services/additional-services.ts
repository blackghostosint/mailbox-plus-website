...
export const additionalServices: Service[] = [
...

  {
    ...
    canonicalUrl: 'https://mailboxplusohio.com/home-business/notary-services',
  ...
  },
  {
    ...
    canonicalUrl: 'https://mailboxplusohio.com/fedex-easy-returns',
  ...
  },
  {
    ...
    canonicalUrl: 'https://mailboxplusohio.com/business-services-concord-township',
        ...
        body: `<div class="grid md:grid-cols-2 gap-8">
              ...
              <div class="space-y-3">
                <div class="flex items-start gap-3 p-3 bg-[var(--color-bg-primary)] rounded-xl border border-[var(--color-border)] shadow-sm">
                  <div class="w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center shrink-0 text-blue-600"><svg aria-hidden="true" focusable="false" class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M7 7v10"/><path d="M17 7v10"/><path d="M7 12h10"/></svg></div>
                ...
                <div class="flex items-start gap-3 p-3 bg-[var(--color-bg-primary)] rounded-xl border border-[var(--color-border)] shadow-sm">
                  <div class="w-8 h-8 rounded-full bg-purple-50 flex items-center justify-center shrink-0 text-purple-600"><svg aria-hidden="true" focusable="false" class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg></div>
        ...
        body: `<div class="grid md:grid-cols-2 gap-6 mb-8">
              <div class="p-6 bg-[var(--color-bg-warm-tint)] rounded-2xl border border-[var(--color-border)]">
                ...
                <ul class="space-y-2 text-sm text-[var(--color-text-secondary)]">
                  ...
                  <li class="flex items-start gap-2"><svg aria-hidden="true" focusable="false" class="w-4 h-4 text-red-400 shrink-0 mt-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>Hoping the return actually went through</li>
                  <li class="flex items-start gap-2"><svg aria-hidden="true" focusable="false" class="w-4 h-4 text-red-400 shrink-0 mt-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>Explaining the process to untrained staff</li>
                </ul>
              </div>
              <div class="p-6 bg-[var(--color-bg-primary)] rounded-2xl border border-green-200 shadow-sm">
                ...
                <ul class="space-y-2 text-sm text-[var(--color-text-secondary)]">
                  ...
                  <li class="flex items-start gap-2"><svg aria-hidden="true" focusable="false" class="w-4 h-4 text-green-500 shrink-0 mt-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Receipt in hand, refund initiated, done</li>
                  <li class="flex items-start gap-2"><svg aria-hidden="true" focusable="false" class="w-4 h-4 text-green-500 shrink-0 mt-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Friendly staff who know exactly how it works</li>
                </ul>
              </div>
            </div>
