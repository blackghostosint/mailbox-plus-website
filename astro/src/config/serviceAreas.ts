...
export const serviceAreas: Service[] = [
  {
    ...
    features: [
      ...
      { title: 'Full Carrier Access', description: 'UPS, FedEx, USPS & DHL — all under one roof' },
      {
        ...
        description: 'Proudly serving Concord Township and Lake County since 2024',
      },
    ],
    faqs: [
      {
        ...
        answer:
          'Yes, we offer package pickup for all major carriers, including UPS, FedEx, DHL, and USPS, right here in Concord Township.',
        isFeatured: true,
      },
      {
        id: 'faq-concord-2',
        ...
        answer:
          'We are conveniently located in Gristmill Village, just a short drive from the center of Concord Township, making it easy to drop off packages or use our services.',
      },
    ],
  },
  {
    ...
    features: [
      ...
      {
        title: 'Community Focused',
        description: 'Proudly serving Mentor’s growing business community',
      },
    ],
    faqs: [
      {
        ...
        answer:
          "Absolutely! We offer convenient notary services for Mentor residents. Stop by during our business hours, and we'll be happy to assist you with your legal and official documents.",
        isFeatured: true,
      },
      {
        id: 'faq-mentor-2',
        ...
        answer:
          "We are open Monday through Saturday. Our extended hours are designed to accommodate the busy schedules of our Mentor customers, whether you're coming from work or home.",
      },
    ],
  },
  {
    ...
    features: [
      ...
      { title: 'All Major Carriers', description: 'UPS, FedEx, USPS & DHL access in one stop' },
      {
        ...
        description: 'Supporting Lake County offices, schools, and small businesses',
      },
    ],
    faqs: [
      {
        ...
        answer:
          'Yes, we are a popular choice for Lake Erie College students who need to ship belongings, textbooks, and care packages. We offer packing supplies and expert advice to ensure your items arrive safely.',
        isFeatured: true,
      },
      {
        ...
        answer:
          'Not at all! We are just a short and convenient drive from downtown Painesville, making it easy for you to access our full range of services without the hassle.',
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        description: 'Easy access from Eastlake to our Concord Township location',
      },
      {
        title: 'Full Carrier Options',
        description: 'UPS, FedEx, USPS & DHL available for all your shipping needs',
      },
      {
        title: 'Community Focused',
        description: 'Supporting Lake County’s local families and small businesses since 2024',
      },
    ],
    faqs: [
      {
        ...
        answer:
          "Yes, we specialize in custom packing and shipping for large, fragile, and valuable items. Whether it's artwork, electronics, or sports equipment, we ensure it's packed securely for transit from Eastlake.",
        isFeatured: true,
      },
      {
        id: 'faq-eastlake-2',
        ...
        answer:
          'We offer a suite of business services, including mailbox rentals with a real street address, document shredding, and high-quality printing for marketing materials, all designed to support the growth of Eastlake businesses.',
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        answer:
          "Yes, we provide a wide range of printing services, including business cards, flyers, banners, and more, all with a quick turnaround to help Willoughby's small businesses make a great impression.",
        isFeatured: true,
      },
      {
        id: 'faq-willoughby-2',
        ...
        answer:
          'We offer a full range of shipping options through UPS, FedEx, DHL, and USPS, giving Willoughby residents the flexibility to choose the best service for their needs and budget.',
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        answer:
          'Yes, we accept pre-paid drop-offs for UPS, FedEx, DHL, and USPS, making it easy for Wickliffe residents to get their packages on their way without any extra hassle.',
        isFeatured: true,
      },
      {
        id: 'faq-wickliffe-2',
        ...
        answer:
          'We have a wide selection of packing and shipping supplies available in our store, from boxes and tape to bubble wrap and packing peanuts, all conveniently located for our Wickliffe customers.',
      },
    ],
  },
  {
    ...
    features: [
      ...
      { title: 'Full Carrier Access', description: 'UPS, FedEx, USPS & DHL — all under one roof' },
      {
        ...
        description: 'Proudly serving Madison and Lake County since 2024',
      },
    ],
    faqs: [
      {
        ...
        answer:
          "Yes, we can help Madison's wineries and local businesses with everything from shipping products to printing marketing materials. We understand the unique needs of local entrepreneurs.",
        isFeatured: true,
      },
      {
        id: 'faq-madison-2',
        ...
        answer:
          'We are located a convenient drive from Madison, offering a great alternative to crowded post offices and providing a full suite of services in one friendly location.',
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        description: 'Dedicated to serving Lake County communities',
      },
      {
        title: 'Full Carrier Access',
        description: 'UPS, FedEx, USPS & DHL — all in one convenient stop',
      },
      {
        title: 'Trusted Local Partner',
        description: 'Supporting Perry residents and small businesses since 2024',
      },
    ],
    faqs: [
      {
        ...
        answer:
          "Absolutely! We can pack and ship a wide variety of items, including products from local farms and nurseries. We'll ensure your goods are packed securely to arrive in great condition.",
        isFeatured: true,
      },
      {
        id: 'faq-perry-2',
        ...
        answer:
          'Yes, our location is easily accessible from Perry, providing a convenient one-stop shop for all your shipping and business needs without having to travel far from home.',
      },
    ],
  },
  {
    ...
    features: [
      ...
      {
        title: 'Rooted in Local Heritage',
        description: 'Proudly serving Kirtland’s historic and natural community since 2024',
      },
    ],
    faqs: [
      {
        ...
        answer:
          "We can help visitors ship souvenirs and other items home, so you don't have to worry about packing them in your luggage. We make it easy to send a piece of Kirtland to your loved ones.",
        isFeatured: true,
      },
      {
        id: 'faq-kirtland-2',
        ...
        answer:
          "A private mailbox rental offers a secure, professional address for your mail and packages, available during business hours. It's a great solution for home-based businesses or frequent travelers in Kirtland.",
      },
    ],
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description: 'Supporting Chardon and Geauga County since 2024',
      },
    ],
    faqs: [
      {
        ...
        answer:
          "Yes, we are equipped to handle large and heavy items with our freight shipping options. Whether it's furniture, equipment, or a large order, we can get it shipped from Chardon.",
        isFeatured: true,
      },
      {
        id: 'faq-chardon-2',
        ...
        answer:
          'We offer professional graphic design services to help you create stunning marketing materials, from logos and business cards to brochures and banners, all designed to make your Chardon business stand out.',
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        description: 'Tailored solutions for Fairport Harbor customers',
      },
      {
        title: 'Full Carrier Access',
        description: 'UPS, FedEx, USPS & DHL — all in one convenient stop',
      },
      {
        ...
        description: 'Proudly serving Fairport Harbor and Lake County since 2024',
      },
    ],
    faqs: [
      {
        ...
        answer:
          'Yes, we offer international shipping with DHL, FedEx, and UPS, making it easy to send packages to friends, family, and business partners around the world from Fairport Harbor.',
        isFeatured: true,
      },
      {
        ...
        answer:
          'We offer specialized packing services and insurance options to ensure that your fragile and valuable items are protected during transit. Ship with confidence from Fairport Harbor.',
      },
    ],
  },
  {
    ...
    features: [
      ...
      {
        title: 'Rooted in Community',
        description: 'Proudly serving Geneva and Ashtabula County since 2024',
      },
    ],
    faqs: [
      {
        ...
        answer:
          'Yes, we are experienced in packing and shipping wine, and we can help you send your favorite local vintages to friends and family. We offer a variety of packing options to ensure your wine arrives safely.',
        isFeatured: true,
      },
      {
        id: 'faq-geneva-2',
        ...
        answer:
          'We can help you design and print a wide range of marketing materials, including brochures, flyers, and direct mail campaigns, to help you reach more customers in the Geneva area.',
      },
    ],
  },
  {
  ...
  },
  {
    id: 'chardon-township',
    category: 'core',
    serviceName: 'Chardon Township Services',
    slug: 'chardon-township',
    canonicalUrl: '/service-area/chardon-township',
    priorityServices: ['pack-ship', 'mailbox-rental'],
    city: 'Chardon Township',
    pageTitle: 'Shipping & Printing in Chardon Township, Ohio',
    metaDescription:
  ...
  },
  {
    id: 'munson-township',
    category: 'core',
    serviceName: 'Munson Township Services',
    slug: 'munson-township',
    canonicalUrl: '/service-area/munson-township',
    priorityServices: ['pack-ship', 'mailbox-rental'],
    city: 'Munson Township',
    pageTitle: 'Shipping & Printing in Munson Township, Ohio',
    metaDescription:
  ...
  },
  {
    id: 'willoughby-hills',
    category: 'core',
    serviceName: 'Willoughby Hills Services',
    slug: 'willoughby-hills',
    canonicalUrl: '/service-area/willoughby-hills',
    priorityServices: ['pack-ship', 'mailbox-rental'],
    city: 'Willoughby Hills',
    pageTitle: 'Shipping & Printing in Willoughby Hills, Ohio',
    metaDescription:
