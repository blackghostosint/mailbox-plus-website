    ...
    content: [
      {
        ...
        body: `<img src="https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/pack-ship.webp" alt="Mailbox Plus drop-off counter for Vinted packages" class="w-full rounded-2xl shadow-md my-8" loading="lazy" width="1200" height="675" />
