    ...
    content: [
      {
        ...
        body: `<img src="https://pub-21518ce3034449a3a7b5a0b89551f710.r2.dev/vinted-drop-off-featured.webp" alt="Clothing item in a poly mailer with prepaid shipping label ready for drop-off at a service counter" class="w-full rounded-2xl shadow-md my-8" loading="lazy" width="1200" height="675" />
