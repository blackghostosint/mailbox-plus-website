...
export const shippingMicroProblems: Service[] = [
  {
    ...
    metaDescription:
      "Shipping something breakable and terrified it'll arrive in pieces? We pack fragile items every single day—glassware, dishes, electronics, collectibles. We know how to protect it.",
...
<li>Any documentation if it's valuable (for insurance purposes)</li>
    ...
    faqs: [
      {
        ...
        answer:
          "We can't guarantee carriers won't be rough, but we can guarantee your item is packed to withstand normal (and abnormal) handling. We've had a 99%+ success rate with fragile shipments.",
      },
      {
        question: 'Should I insure it?',
        answer:
          "If it's worth more than $100 or irreplaceable, yes. Insurance costs about $1–2 per $100 of value.",
      },
      {
        question: "What's double-boxing?",
        answer:
          "We pack the item in a smaller box with cushioning, then place that box inside a larger box with more cushioning. It's the gold standard for fragile items.",
      },
    ],
    cta: {
  ...
  },
  {
    ...
    pageTitle: 'Ship Odd-Sized Items in Concord Township | Mailbox Plus',
    metaDescription:
...
<li>Any disassembly instructions if it comes apart</li>
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes. We partially disassemble (remove pedals, turn handlebars), box it in a bike-specific box, and ship via ground service.',
      },
      {
        question: 'Is freight cheaper for big items?',
        answer:
          "Sometimes. If it's over 150 lbs or 108 inches combined length+width+height, freight might be cheaper.",
      },
    ],
    cta: {
  ...
  },
  {
    ...
    metaDescription:
      'Shipping something heavy and worried the carrier will refuse it? Weight limits are real—and confusing. We know exactly which carriers take what weight, and how to pack it so it&apos;s accepted.',
...
<li>Patience—we'll show you options and you pick what makes sense</li>
    ...
    faqs: [
      {
        ...
        answer:
          'Then it goes freight, not parcel. Freight is cheaper for heavy items but takes longer (5–10 business days). We can arrange freight pickup.',
      },
      {
        question: 'Will the box hold up?',
        answer:
          'If we pack it, yes. We use boxes rated for the weight and reinforce stress points.',
      },
      {
        question: 'Can I split it into multiple boxes to avoid freight?',
        answer:
          "Sometimes that makes sense, sometimes it doesn't. We'll do the math and show you both options.",
      },
    ],
    cta: {
  ...
  },
  {
    ...
    metaDescription:
      "Shipping a phone, laptop, or tablet and worried it'll get damaged or stolen? Electronics need special packing—and sometimes special handling. We do this daily.",
...
<li>Proof of value (receipt or email) if you want insurance</li>
    ...
    faqs: [
      {
        ...
        answer:
          "Yes, if it's a phone, tablet, or computer. Factory reset recommended. We can't be responsible for data.",
      },
      {
        question: 'Do I need insurance?',
        answer:
          "For anything worth over $100, yes. Carriers only cover $100 by default. Insurance costs about 1–2% of the item's value.",
      },
      {
        question: "What if it's a desktop computer?",
        answer:
          'We remove any loose components (graphics card, hard drives), pack them separately, and cushion the case. Then ship in a custom box.',
      },
    ],
    cta: {
  ...
  },
  {
    ...
    pageTitle: 'Ship Artwork & Collectibles in Concord | Mailbox Plus',
    metaDescription:
    ...
    heroSubtitle:
      'Shipping something irreplaceable? A painting, framed photo, signed poster, or collectible? We treat these like museum pieces—because to you, they are.',
...
<li>Any documentation of value (appraisal, receipt, certificate)</li>
    ...
    faqs: [
      {
        ...
        answer:
          'Yes. We\'ve shipped pieces up to 48" x 60". Larger than that may require custom crating or freight.',
      },
      {
        question: 'Should I remove the glass from the frame?',
        answer:
          "Depends. If it's valuable, yes—ship the glass separately. If it's standard glass and securely framed, we can pack it as-is.",
      },
    ],
    cta: {
  ...
  },
  {
    ...
    pageTitle:
      'Ship Documents Securely and Flat in Concord Township – Contracts, Certificates, Legal Papers | Mailbox Plus',
    metaDescription:
      "Need to mail important documents that can't bend, fold, or get lost? Birth certificates, legal contracts, diplomas, tax forms? We ship documents securely every day.",
    heroTitle:
      'Ship Documents Securely and Flat in Concord Township – Contracts, Certificates, Legal Papers',
    heroSubtitle:
      "Need to mail important documents that can't bend, fold, or get lost? Birth certificates, legal contracts, diplomas, tax forms? We ship documents securely every day.",
...
<li>Any special instructions (signature required, specific person, etc.)</li>
    ...
    faqs: [
      {
        ...
        answer:
          'USPS Certified gives you proof of mailing and delivery for about $4–$7. UPS/FedEx cost more but are faster and include $100 insurance.',
      },
      {
        question: "What if they're time-sensitive (deadline tomorrow)?",
        answer:
          'We offer overnight and same-day options via FedEx or UPS. Bring them in by 4pm for same-day pickup.',
      },
    ],
    cta: {
  ...
  },
  {
    ...
    metaDescription:
      'Need to send a gift without pricing showing? We remove receipts, invoices, and price tags, repack cleanly, and ship with a handwritten note.',
    heroTitle: 'Ship a Gift Without the Receipt or Invoice',
    heroSubtitle:
      "Sending a gift and don't want the price to show? Or did the retailer include a receipt in the box? We'll repack it cleanly so the recipient just gets the gift—no pricing, no invoices.",
...
<li>Shipping preference (speed, carrier, etc.)</li>
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "We can pack it inside a plain outer box so the brand isn't visible until they open it.",
      },
      {
  ...
  },
  {
    ...
    metaDescription:
      'Not sure which carrier to use or what the rules are? We compare UPS, FedEx, and USPS daily and explain restrictions, costs, and timelines.',
    heroTitle: "Unsure of Carrier Rules? We'll Figure It Out",
    heroSubtitle:
      "Not sure if UPS, FedEx, or USPS is the right choice? Confused about size limits, weight restrictions, or what you can't ship? We deal with this every single day—we'll walk you through it.",
    heroImage: getServiceImageUrl('/images/micro/pack-ship.webp'),
    content: [
      {
        heading: 'What We Do',
...
<li>Your timeline (does it need to arrive by a certain date?)</li>
    ...
    faqs: [
      {
        ...
        answer:
          "We'll quote all three (UPS, FedEx, USPS) and show you the cost and delivery time for each. You pick.",
      },
      {
        question: 'Can I ship lithium batteries?',
        answer:
          "Depends. Small lithium batteries (in phones, laptops) are okay with restrictions. Loose batteries or large lithium packs often aren't. We'll check.",
      },
      {
        question: 'What if I need it there by Monday?',
        answer:
          "We'll show you overnight, 2-day, and 3-day options from each carrier and tell you the latest drop-off time for Monday delivery.",
      },
    ],
    cta: {
  ...
  },
  {
    ...
    pageTitle: 'Ship Fragile Items Safely in Concord Township | Mailbox Plus',
    metaDescription:
    ...
    heroSubtitle:
      'Got something delicate, expensive, or sentimental that absolutely cannot get damaged? We use professional-grade packing materials—foam inserts, corner protectors, double-boxing—to protect it.',
    heroImage: getServiceImageUrl('/images/micro/pack-ship.webp'),
    content: [
      {
        heading: 'What We Do',
    ...
    faqs: [
      {
        ...
        answer:
          'Minimum 2 inches on all sides. For fragile items, 3+ inches. The item should not touch any wall of the outer box.',
      },
      {
        question: "What's the difference between bubble wrap and foam?",
        answer:
          'Bubble wrap is good for light protection. Foam is better for impact absorption. For fragile items, we use both.',
      },
      {
        question: 'Should I insure it?',
        answer:
          "If it's worth more than $100 or irreplaceable, yes. Insurance costs vary based on the item's value.",
      },
    ],
    cta: {
...
<li>Your phone for the tracking number</li>
    ...
    faqs: [
      {
        ...
        answer:
          'Simple items (clothes, books, non-fragile): 5-10 minutes. Fragile or complex items: 15-20 minutes.',
      },
      {
        question: 'What if I need it there overnight?',
        answer:
          'We offer FedEx and UPS overnight options. Drop off by 4pm for next-day delivery (to most locations).',
      },
      {
  ...
  },
  {
    ...
    metaDescription:
      'Burned by lost receipts or unresponsive stores? We guarantee tracking numbers, printed receipts, and responsive service. Walk out with proof your package was shipped—every time.',
    heroTitle: 'Ship with Guaranteed Proof & Tracking',
    heroSubtitle:
      "Lost a receipt? Package never showed up in tracking? Store won't answer? We guarantee you'll walk out with a printed receipt, tracking number, and responsive service if something goes wrong.",
    heroImage: getServiceImageUrl('/images/micro/pack-ship.webp'),
    content: [
      {
        heading: 'What We Do',
    ...
    faqs: [
      {
        ...
        answer:
          'Call us. We keep digital records of all shipments. We can look it up by your name, date, or destination address.',
      },
      {
        question: 'Will the package show up in tracking right away?',
        answer:
          "Yes. We scan it into the carrier system before it leaves our store. You'll see the first tracking scan within hours.",
      },
      {
        question: 'What if the carrier loses the package?',
        answer:
          'We file the claim for you. We have the proof: receipt, tracking number, weight, dimensions, and carrier acceptance scan.',
      },
      {
        question: 'Do you answer the phone?',
        answer:
          "Yes. We're a local business in Concord Township. Call during business hours and you'll talk to a real person who can help.",
      },
    ],
    cta: {
