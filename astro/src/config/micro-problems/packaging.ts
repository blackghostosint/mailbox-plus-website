...
export const packagingMicroProblems: Service[] = [
  {
    ...
    metaDescription:
      "Box fell apart before you could ship it? Or did the carrier reject it because it's torn or crushed? Happens all the time. We'll repack it into a sturdy box in under 10 minutes.",
    heroTitle: 'Repackage a Damaged or Torn Shipping Box in Concord Township',
    heroSubtitle:
      "Box fell apart before you could ship it? Or did the carrier reject it because it's torn or crushed? Happens all the time. We'll repack it into a sturdy box in under 10 minutes.",
    heroImage:
      'https://images.unsplash.com/photo-1566576721346-d4a3b4eaeb55?auto=format&fit=crop&q=80&w=2000',
    content: [
      {
        heading: 'What We Do',
...
<li>A few minutes—this is quick</li>
    ...
    faqs: [
      {
        ...
        answer:
          "If the box is structurally sound, yes. But if it's crushed, wet, or split at the seams, it needs a new box or the carrier will reject it again.",
      },
      {
  ...
  },
  {
    ...
    heroSubtitle:
      "Shipping several items to the same person and don't want to pay for multiple boxes? We'll combine them into one shipment, packed securely so nothing shifts or breaks.",
...
<li>Destination address</li>
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'We pack the fragile item with extra padding and place it in the center, away from pressure points.',
      },
      {
        question: 'Is there a limit to how many items you can fit in one box?',
        answer:
          "Weight and size limits apply (usually 50–70 lbs and under 108\" combined dimensions). If it's over that, we'll split into two shipments.",
      },
    ],
    cta: {
  ...
  },
  {
    ...
    metaDescription:
      "Lost the box? We pack items without original packaging—clothes, toys, kitchen items, random stuff. We'll find the right box and pack it properly at Mailbox Plus in Concord Township, OH.",
    heroTitle: 'Ship Something With No Original Packaging in Concord Township',
    heroSubtitle:
      "Lost the box? Never had one? Doesn't matter. We pack items without original packaging all day long—clothes, toys, kitchen items, random stuff. We'll find the right box and pack it properly.",
...
<li>Any accessories or parts that go with it</li>
    ...
    faqs: [
      {
        ...
        answer:
          "We'll custom-pack it. We've shipped lamps, sculptures, car parts, musical instruments—weird shapes are our specialty.",
      },
      {
        question: 'Can you pack something soft like clothes or blankets?',
        answer:
          'Yes. We use poly mailers or boxes depending on the size and whether it needs to stay dry.',
      },
      {
  ...
  },
  {
    ...
    heroSubtitle:
      "Not sure where the label goes? Worried you'll put it in the wrong spot and delay your shipment? We print and attach labels all day—we'll do it right so there's no confusion.",
...
<li>2 minutes of your time</li>
    ...
    faqs: [
      {
        ...
        answer:
          'Carriers scan barcodes at every facility. If the label is wrinkled, covered, or in the wrong spot, it delays your package or gets sent to the wrong place.',
      },
      {
        question: 'Can I just tape a paper label on?',
        answer:
          'You can, but it might fall off or get wet. Adhesive labels stay put. We use those.',
      },
      {
        question: "What if there's an old label on the box?",
        answer:
          "We remove it or cover it completely so scanners don't pick up the wrong tracking number.",
      },
    ],
    cta: {
  ...
  },
  {
    ...
    heroSubtitle:
      "Not sure what size box to use? Worried it's too big (and you'll pay more) or too small (and it'll get damaged)? We'll measure your item and pick the perfect box.",
...
<li>Destination address (affects pricing)</li>
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. Carriers charge by dimensional weight: (Length × Width × Height) / 166. A box that's even 2 inches bigger can jump you to the next price tier.",
      },
      {
        question: 'Can I use a smaller box to save money?',
        answer:
          "Only if there's still room for padding. We won't sacrifice protection to save $5 on shipping.",
      },
    ],
    cta: {
