...
keywords:
  [
    'Amazon returns Concord Township',
...
The shirt does not fit. The blender stopped working after three uses. The book that was supposed to be hardcover arrived in paperback. Whatever the reason, you need to send it back to Amazon.
