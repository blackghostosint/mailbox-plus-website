 ...
 */
function validateLength(formattedResponse: string, config: TemplateConfig): { isValid: boolean; error?: string } {
 ...
 */
function validateForbiddenPhrases(formattedResponse: string, config: TemplateConfig): { isValid: boolean; errors: string[] } {
 ...
 */
function validateSectionPresence(response: V1Response, config: TemplateConfig): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
 ...
 */
function validateAcknowledgment(acknowledgment: string, config: TemplateConfig): { isValid: boolean; error?: string } {
 ...
 */
export function validateV1Response(response: V1Response, config: TemplateConfig = DEFAULT_CONFIG): ValidationResult {
    const errors: string[] = [];
 ...
 */
export function formatMailbotResponse(rawAnswer: string, config: TemplateConfig = DEFAULT_CONFIG): string {
